...
Using this json interface ABCDeweb3.js is able to create JavaScript object representing the smart contract and its methods and events using the :ref:`ABCDeweb3.eth.Contract object <eth-contract>`.
...
- ``type``: ``"function"``, ``"constructor"`` (can be omitted, defaulting to ``"function"``; ``"fallback"`` also possible but not relevant in ABCDeweb3.js);
